...
def Info():
    ...
    icon_image=PhotoImage(file="DepIMGS/info.png")
...
image_icon=PhotoImage(file='DepImgs/MainIcon.png')
root.iconphoto(False,image_icon)


##header section
logo=PhotoImage(file='DepIMGS/header.png')
...
Entry_image=PhotoImage(file='DepIMGS/Rounded Rectangle 1.png')
Entry_image2=PhotoImage(file='DepIMGS/Rounded Rectangle 2.png')
...
##############################Report ##############
square_report_image = PhotoImage(file='DepIMGS/Report.png')
...
#####################Graph
graph_image=PhotoImage(file="DepIMGS/graph.png")
...
smoking_icon=PhotoImage(file='DepIMGS/smoker.png')
non_smoking_icon=PhotoImage(file='DepIMGS/non-smoker.png')
...
##########logout button
logout_icon=PhotoImage(file='DepIMGS/logout.png')
